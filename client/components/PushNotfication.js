...
export default class PushNotification extends Component {
  ...
  onSubmit = async() => {
    ...
    Notifications.addListener(this.handleNotification);
        ...
        let not0 = new Date(2020, 4, 12, 10, 0, 0);
        not0 = Date.parse(not0);
        let not1 = new Date(2020, 4, 13, 10, 0, 0);
        not1 = Date.parse(not1);
        let not2 = new Date(2020, 4, 14, 10, 0, 0);
        not2 = Date.parse(not2);
        let not3 = new Date(2020, 4, 15, 10, 0, 0);
        not3 = Date.parse(not3);
        let not4 = new Date(2020, 4, 16, 10, 0, 0);
        not4 = Date.parse(not4);
        let not5 = new Date(2020, 4, 10, 10, 0, 0);
        not5 = Date.parse(not5);
        let not6 = new Date(2020, 4, 10, 10, 0, 0);
        not6 = Date.parse(not6);

        let not10 = new Date(2020, 4, 12, 20, 0, 0);
        not10 = Date.parse(not10);
        let not11 = new Date(2020, 4, 13, 20, 0, 0);
        not11 = Date.parse(not11);
        let not12 = new Date(2020, 4, 14, 20, 0, 0);
        not12 = Date.parse(not12);
        let not13 = new Date(2020, 4, 15, 20, 0, 0);
        not13 = Date.parse(not13);
        let not14 = new Date(2020, 4, 16, 20, 0, 0);
        not14 = Date.parse(not14);
        let not15 = new Date(2020, 4, 10, 20, 0, 0);
        not15 = Date.parse(not15);
        let not16 = new Date(2020, 4, 10, 20, 0, 0);
